...
export const HERO_FRAMES = [
  <svg key="0" viewBox="0 0 348 454" preserveAspectRatio="xMidYMid slice" style={{ width: '100%', height: '100%', display: 'block' }}>
    <rect width="348" height="454" fill="#3A2A5E" />
    <circle cx="290" cy="82" r="33" fill="#E9A93C" />
    <circle cx="62" cy="64" r="7" fill="#F6EFE3" opacity="0.5" />
    <circle cx="104" cy="44" r="4.5" fill="#F6EFE3" opacity="0.4" />
    <circle cx="298" cy="168" r="5.5" fill="#F6EFE3" opacity="0.4" />
    <circle cx="174" cy="244" r="124" fill="#F6EFE3" opacity="0.06" />
  ...
  <svg key="1" viewBox="0 0 348 454" preserveAspectRatio="xMidYMid slice" style={{ width: '100%', height: '100%', display: 'block' }}>
    ...
    <circle cx="60" cy="60" r="6" fill="#F6EFE3" opacity="0.4" />
    <circle cx="300" cy="150" r="5" fill="#F6EFE3" opacity="0.4" />
    <circle cx="174" cy="250" r="122" fill="#F6EFE3" opacity="0.06" />
    <rect x="0" y="404" width="348" height="50" fill="#2E1F47" />
  ...
  <svg key="2" viewBox="0 0 348 454" preserveAspectRatio="xMidYMid slice" style={{ width: '100%', height: '100%', display: 'block' }}>
    ...
    <circle cx="60" cy="64" r="6" fill="#F6EFE3" opacity="0.4" />
    <circle cx="300" cy="160" r="5" fill="#F6EFE3" opacity="0.4" />
    <circle cx="174" cy="246" r="122" fill="#F6EFE3" opacity="0.06" />
    ...
    <rect x="170" y="402" width="6" height="48" fill="#3A2A5E" />
  ...
  <svg key="3" viewBox="0 0 348 454" preserveAspectRatio="xMidYMid slice" style={{ width: '100%', height: '100%', display: 'block' }}>
    ...
    <circle cx="58" cy="60" r="6" fill="#F6EFE3" opacity="0.4" />
    <circle cx="300" cy="150" r="5" fill="#F6EFE3" opacity="0.4" />
    <rect x="0" y="392" width="348" height="62" fill="#2E1F47" />
    ...
    <circle cx="156" cy="250" r="16" fill="#3A2A5E" />
